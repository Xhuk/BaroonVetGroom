    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <main className="lg:ml-72 pb-40">
        ...
        {showCalendar ? (
          ...
          <div className="mx-6 bg-white rounded-lg shadow-lg animate-pulse flex items-center justify-center fixed top-20" style={{ bottom: 'calc(10px + 96px)', right: '24px', left: '312px' }}>
