...
export default function ReceiptTemplatesAdmin() {
  ...
  const handleLogoUpload = async (file: File) => {
    ...
    try {
      ...
      const res = await apiRequest('/api/objects/upload', 'POST', uploadParams);
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-blue-700 dark:text-blue-300 space-y-2">
                        <p>
                          <span className="font-medium">Plantillas Empresariales:</span> Sirven como plantilla predeterminada para todas las clínicas de la empresa. Cuando se crea una plantilla empresarial, automáticamente se convierte en el estándar para todas las ubicaciones.
                        </p>
                        <p>
                          <span className="font-medium">Plantillas de Clínica:</span> Son específicas para una clínica individual y tienen prioridad sobre la plantilla empresarial para esa ubicación específica.
                        </p>
                        <p>
                          <span className="font-medium">Lógica de Herencia:</span> Si una clínica no tiene una plantilla específica, utilizará automáticamente la plantilla empresarial. En caso de no existir plantilla empresarial, las clínicas sin plantilla específica heredarán la primera plantilla de clínica disponible en la empresa.
                        </p>
                      </div>
                    </div>
                  </div>
